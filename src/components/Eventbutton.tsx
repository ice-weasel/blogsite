  ...
  return (
    <div style={{ position: "relative" }}>
      <button
        ...
        className="text-white bg-blue-700 hover:bg-white hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-black dark:hover-bg-black dark:focus:ring-white"
      >
        Events{" "}
        <svg
